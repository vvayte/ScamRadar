...
export default function PricingPageClient({ currency }: { currency: Currency }) {
  const { t } = useT();
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="relative flex min-h-[28rem] flex-col rounded-2xl border border-cyan-300/40 bg-cyan-500/[0.06] p-6">
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-black tracking-tight">{priceFor("monthly", currency)}</span>
            ...
            <div className="relative flex min-h-[28rem] flex-col rounded-2xl border border-white/12 bg-white/[0.04] p-6">
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-black tracking-tight">{priceFor("yearly", currency)}</span>
            ...
            <div className="relative flex min-h-[28rem] flex-col rounded-2xl border border-white/12 bg-white/[0.025] p-6">
              ...
              <div className="mt-3 flex items-baseline gap-1">
                <span className="text-4xl font-black tracking-tight">{priceFor("lifetime", currency)}</span>
